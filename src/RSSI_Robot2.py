...
rospy.init_node("rssi_robot_2")
pub = rospy.Publisher("robot2_ap_data", Float32MultiArray, queue_size=10)
sub1 = rospy.Subscriber("robot1_ap_data", Float32MultiArray, lambda m: data_cb(1, m))
sub3 = rospy.Subscriber("robot3_ap_data", Float32MultiArray, lambda m: data_cb(3, m))
pose_pub = rospy.Publisher("robot2_relative", Float32MultiArray, queue_size=10)
robot_pose = None
other_data = {}
...
rospy.Subscriber("robot2_pose", PoseStamped, pose_cb)
