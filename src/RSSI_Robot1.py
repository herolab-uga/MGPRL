...
rospy.init_node("rssi_robot_1")
pub = rospy.Publisher("robot1_ap_data", Float32MultiArray, queue_size=10)
...
pose_pub = rospy.Publisher("robot1_relative", Float32MultiArray, queue_size=10)
robot_pose = None
other_data = {}
...
rospy.Subscriber("robot1_pose", PoseStamped, pose_cb)
